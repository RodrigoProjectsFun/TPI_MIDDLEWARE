...
if (!empty($_GET['id'])) {
    ...
    if ($data && isset($data['product_id'])) {
        ...
        // Fetch deviceID from UUIDContainer.php
        include 'UUIDContainer.php';
        // Assuming UUIDContainer.php directly outputs the $deviceID
        $deviceID = trim($deviceID); // Ensure no extra spaces or line breaks
        ...
        echo "<tr><td width='113' align='left' class='lf'>Nombre del producto</td><td style='font-weight:bold'>:</td><td align='left'>" . htmlspecialchars($data['name']) . "</td></tr>";
        echo "<tr bgcolor='#f2f2f2'><td align='left' class='lf'>Descripción del producto</td><td style='font-weight:bold'>:</td><td align='left'>" . htmlspecialchars($data['product_description']) . "</td></tr>";
        echo "<tr><td align='left' class='lf'>Precio del producto</td><td style='font-weight:bold'>:</td><td align='left'>" . htmlspecialchars($data['product_price']) . "</td></tr>";
        echo "<tr bgcolor='#f2f2f2'><td align='left' class='lf'>UID de la etiqueta</td><td style='font-weight:bold'>:</td><td align='left'>" . htmlspecialchars($data['tag_id']) . "</td></tr>";
    ...
    echo "<p>ID de etiqueta no proporcionado.</p>";
}
?>
